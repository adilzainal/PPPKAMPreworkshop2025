#	Using ChatGPT for debugging, generating R scripts, and exploring alternative approaches.
#====Using chattr for link chatgpt in rstudio====
install.packages("chattr")
library(chattr)
library(shiny)

Sys.setenv("OPENAI_API_KEY" = "your api here") 
...
#click stop application everytime finish chat and to resume runnign code
